...
export const ValuesBlock = ({ className, title, paragraph, number }) => {
  return (
    <div className="bg-white text-center md:text-left shadow-lg hover:shadow-2xl transition-all delay-100 ease-in  rounded-lg  py-10 px-3 md:pt-14 md:pb-14 space-y-4 md:space-y-10 md:px-7 ">
