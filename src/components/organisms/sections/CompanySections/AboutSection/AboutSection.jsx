...
export const AboutSection = () => {
  return (
    <div className=" pb-20">
      <div className="containerBox grid md:grid-cols-2 gap-16">
        <div className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <Text level={1}>
              SmartSaver aims to revolutionize FinTech services provided to the
              people; giving them easy, smarter and better living options.
          ...
          <div className="space-y-2">
            ...
            <Text level={1}>
              ...
              puts into consideration our corporate relationships and client and
              staff preferences because we place great importance in sustaining
              lasting relationships with our clients, our staff throughout their
              financial lives.
            </Text>
          </div>
